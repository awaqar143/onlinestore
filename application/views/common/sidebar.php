<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> ALL CATEGOARIES</a>
				<ul>
					
					<?php foreach ($productCat as $productCat) { ?>
				
				<li><a class="active" href="<?php echo base_url('product/ProductSearchSide') ?>?id=<?php echo $productCat->id ?>"><i class="icon-chevron-right"></i><?php echo $productCat->cat_name ?></a></li>
			<?php } ?>
