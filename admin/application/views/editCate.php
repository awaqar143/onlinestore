                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('Category/updateCat'); ?>
                               <input type="hidden" name="id" value="<?php echo $editcate['id']; ?>">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="Cat_name" value="<?php echo $editcate['cat_name']; ?>" class="form-control" placeholder="Category Name">
                                        </div>
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="Cat_desc" value="<?php echo $editcate['cat_desc']; ?>" class="form-control" placeholder="Category Description">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="checkbox" value="1" name="status" class="js-single"
                                             <?php if($editcate['status'] == '1'){ echo "checked"; } ?> />
                                        </div>
                                    </div>
