                            ...
                            <div class="card-block">
                               ...
                               <?php echo form_open_multipart('user/changePassword'); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" disabled="" value="<?php echo $this->session->userdata('username'); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="password" id="confirm_new_password" onkeyup="checkPass(); return false;" name="confirm_password" class="form-control" placeholder="Confirm New Password">
                                        </div>
                                    </div>
