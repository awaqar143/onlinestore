                             ...
                             <div class="card-block">
                                <div class="row">
                                       ...
                                       <label>Select Order Status</label>
                                        <select name="status" class="form-control form-control-default">
                                         ...
                                         <option value="<?php echo $status['status'] ?>"
                                           <?php if($order['status'] == $status['status']) { echo "selected" ;} ?> > <?php echo $status['order_status'] ?></option>
                                                                     <?php } ?>
                                    ...
                                    <div class="col-sm-12 col-xl-3 m-b-30">
                                       ...
                                       <input class="form-control" name="track" placeholder="Tracking number" type="text">
