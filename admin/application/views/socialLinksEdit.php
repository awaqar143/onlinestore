                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('Site_setting/sociallinksEdit'); ?>
                               <input type="hidden" name="id" value="<?php echo $sco['id']; ?>">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Social Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="" readonly value="<?php echo $sco['social_name']; ?>" class="form-control" >
                                        </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="link" value="<?php echo $sco['link']; ?>" class="form-control" >
                                        </div>
