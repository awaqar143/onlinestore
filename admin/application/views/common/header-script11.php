...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/assets/icon/themify-icons/themify-icons.css">
     <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/assets/css/bootstrap.icon-large.css">
      <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/bootstrap.icon-large.min.css">
    <!-- ico font -->
    ...
    <!--color css-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/assets/css/color/color-2.css" id="color"/>
