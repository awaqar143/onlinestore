            ...
            <div class="navbar-logo">
                ...
                <a href="<?php echo base_url(); ?>/dashboard/index">
                 <?php if($this->session->userdata('image') != ""){ ?>
                        <img src="<?php echo base_url(); ?>uploads/userimage/<?php echo $this->session->userdata(''); ?>" alt="Site Logo" class="img-fluid" style="width: auto; height: 30px;" >
                    <?php }else{ ?>
                    ...
                    <ul class="nav-right">
                       <!--  <li class="header-notification lng-dropdown">
                        ...
                        <li class="user-profile header-notification">
                            <a href="#!">
                            <?php if($this->session->userdata('image')){ ?>
                                <img src="<?php echo base_url(); ?>uploads/userimage/<?php echo $this->session->userdata('image'); ?>" alt="User-Profile-Image" style="border-radius: 25px;">
                            <?php }else{ ?>
                                <img src="<?php echo base_url(); ?>uploads/userimage/noimage.png" alt="User-Profile-Image">
                            <?php } ?>
                            ...
                            <ul class="show-notification profile-notification">
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>user/updateUser">
