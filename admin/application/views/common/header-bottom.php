             ...
             <li class="nav-item has-class">
                  ...
                  <li class="nav-item">
                        ...
                        <ul class="tree-1">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>Category/AddCat">Add Category</a></li>
                                    <li><a href="<?php echo base_url(); ?>Category/showAllCat">Manage Category</a></li>
                        ...
                        <ul class="tree-1">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>product/showAllProd">Manage Products</a></li>
                                </ul>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        ...
                        <li><a href="<?php echo base_url(); ?>user/showUser">Manage Users</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                        <a href="#!">
                        ...
                        <ul class="tree-1">
                            <li><a href="<?php echo base_url(); ?>Slider/addProductSlider" data-i18n="nav.basic-components.alert">Add slider</a></li>
                            <li><a href="<?php echo base_url(); ?>Slider/showSliderProd" data-i18n="nav.basic-components.breadcrumbs">List slider</a></li>
                        </ul>
                    </li>
                        ...
                        <ul class="tree-1">
                           <!--  <li><a href="<?php echo base_url(); ?>administrator/site-configuration/update/1">Site Configuration</a></li> -->
                            <li><a href="<?php echo base_url(); ?>site_setting/sco">SCO</a></li>
                            <li> <a href="<?php echo base_url(); ?>site_setting/socialLinks">Social Links</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="tree-1">
                            <li class="nav-sub-item"><a href="<?php echo base_url()?>site_setting/subscribedEmail">Subcribed Email</a>
