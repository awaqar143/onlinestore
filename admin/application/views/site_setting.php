                    ...
                    <div class="card-block">
                        <div class="table-responsive dt-responsive">
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                <?php foreach($sco as $sco) : ?>
                                 <tr>
                                        <td><?php echo $sco['id']; ?></td>
                                        <td><a href=""><?php echo $sco['page_name']; ?></a></td>
                                        <td><a href=""><?php echo $sco['title']; ?></a></td>

                                        
                                        <td>
                                            

                                                <a class="label label-inverse-info" href='<?php echo base_url(); ?>Site_setting/sco_edit/<?php echo $sco['id']; ?>'>Edit</a>
