                                       ...
                                       <!--  <td><?php if($data['status'] == 1) { echo 'active'; }else{ echo 'Inactive' ; } ?></td> -->
                                        <td>
                                            ...
                                            <td>
                                                ...
                                                <a class="label label-inverse-danger delete" href='<?php echo base_url(); ?>Slider/delete/<?php echo $data['id']; ?>?table=<?php echo base64_encode('product'); ?>' onclick="return confirm('Are you sure to delete data?')?true:false;">Delete</a>
